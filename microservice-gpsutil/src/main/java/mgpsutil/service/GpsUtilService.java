...
public class GpsUtilService {
     ...
     */
    public VisitedLocation getLocationGpsUtil(UUID userId) {
    ...
    public List<Attraction> getFiveNearByAttractions(UUID userId) {
        ...
        for (Attraction attraction : gpsUtil.getAttractions()) {
            Double distance = getDistance(attraction, getLocationGpsUtil(userId).location);
    ...
    public HashMap<String, HashMap<String, Double>> getAllCurrentLocations(List<UUID> userIdList) {
      ...
      //  HashMap<String, Double> location = new HashMap<>();
        for (UUID id : userIdList) {
            HashMap<String, Double> location = new HashMap<>();
            location.put("latitude", getLocationGpsUtil(id).location.latitude);
            location.put("longitude", getLocationGpsUtil(id).location.longitude);
...
//    }
     ...
     * @return List<Attraction>
     */
    public List<Attraction> getNearByAttractions(VisitedLocation visitedLocation, boolean isWithinAttractionProximity) {
