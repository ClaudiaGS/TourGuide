...
public class TestTourGuideService {
	...
	public void modifyUserPreferences(){
		...
		newPreferences.put("numberOfAdults","10");
		tourGuideService.modifyUserPreferences(user.getUserName(), newPreferences);
		assertEquals(10,user.getUserPreferences().getNumberOfAdults());
	}
