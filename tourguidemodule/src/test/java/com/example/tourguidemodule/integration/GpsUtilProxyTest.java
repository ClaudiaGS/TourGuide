...
//
//    @Test
//    public void getLocationGpsUtilProxy() throws IOException {
//        String userId = null;
...
//        UUID userIdUuid=user.getUserId();
//        userId = user.getUserId().toString();
//        GpsUtilMocks.setupMockGpsUtilResponse(mockGpsUtilService, userId);
...
//
//        when(mockGpsUtilService.getAllScenarios()).thenReturn(visitedLocation);
//        assert (gpsUtilProxy.getLocation(userId).toString().contains("latitude"));
//
//    }
////    @Test
